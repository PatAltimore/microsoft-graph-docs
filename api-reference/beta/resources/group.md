...
|preferredDataLocation|String| The preferred location to store data related to the group. The property can be set by the group owner when the group is created. The value can be changed by the tenant admin. |
